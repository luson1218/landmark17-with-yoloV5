...
def compute_loss(p, targets, model):  # predictions, targets, model
    ...
    for i, pi in enumerate(p):  # layer index, layer predictions
        ...
        if n:
            ...
            plandmarks[:, 24:26] = plandmarks[:, 24:26] * anchors[i]
            plandmarks[:, 26:28] = plandmarks[:, 26:28] * anchors[i]
            plandmarks[:, 28:30] = plandmarks[:, 28:30] * anchors[i]
            plandmarks[:, 30:32] = plandmarks[:, 30:32] * anchors[i]
            plandmarks[:, 32:34] = plandmarks[:, 32:34] * anchors[i]
...
def build_targets(p, targets, model):
    ...
    for i in range(det.nl):
        ...
        #landmarks 34
        gain[6:40] = torch.tensor(p[i].shape)[[3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2, 3, 2]]  # xyxy gain
        ...
        lks[:, [24, 25]] = (lks[:, [24, 25]] - gij)
        lks[:, [26, 27]] = (lks[:, [26, 27]] - gij)
        lks[:, [28, 29]] = (lks[:, [28, 29]] - gij)
        lks[:, [30, 31]] = (lks[:, [30, 31]] - gij)
        lks[:, [32, 33]] = (lks[:, [32, 33]] - gij)
