...
def build_model():
    ...
    if os.path.isfile(current_path + "/weights/shape_predictor_5_face_landmarks.dat") != True:

        #print(current_path + "./Yolo/deepface/weights/shape_predictor_5_face_landmarks.dat")
    ...
    #print("3lllllllkkkkkkkk")
    face_detector = dlib.get_frontal_face_detector()
    #sp = dlib.shape_predictor(home + "/.deepface/weights/shape_predictor_5_face_landmarks.dat")
    sp = dlib.shape_predictor(current_path + "/weights/shape_predictor_5_face_landmarks.dat")
