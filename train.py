...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp', type=str, default='data/hyp.luson.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='mark17', help='save to project/name')
